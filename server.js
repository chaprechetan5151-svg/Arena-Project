...
app.get('/arena.html', (req, res) => res.sendFile(path.join(__dirname, 'arena.html')));
app.get('/spectate.html', (req, res) => res.sendFile(path.join(__dirname, 'spectate.html')));

// Leaderboard API
app.get('/api/leaderboard', async (req, res) => {
    try {
        const result = await db.query("SELECT username, global_rating FROM users ORDER BY global_rating DESC LIMIT 10");
